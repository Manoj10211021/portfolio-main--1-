...
const projects = [
  ...
  },
  {
    ...
    description:
      " Developed a full-stack blog platform using MongoDB, Express.js, React.js, and Node.js (MERN).Implemented JWT-based authentication for secure login/signup and protected routes.",
    src: "tree.jpg",
    link: "",
    color: "#8f89ff",

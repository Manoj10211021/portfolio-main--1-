...
const SkillsSection = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        { name: "Java", icon: <FaJava className="w-4 h-4 text-[#F24E1E]" /> },
        {
          name: "C",
        ...
        {
          name: "Python",
          icon: <SiPython className="w-4 h-4 text-[#9CA3AF]" />,
        },
        {
          name: "SQL",
